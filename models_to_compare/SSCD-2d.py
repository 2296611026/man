...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.conv = nn.Sequential(nn.Conv2d(512, 128, 1), nn.BatchNorm2d(128), nn.ReLU())
...
class CDBranch(nn.Module):
    def __init__(self):
        ...
        self.db4 = DecoderBlock(256, 128)
        self.db1 = DecoderBlock(128, 128)
        self.db0 = DecoderBlock(128, 128)
        self.up = nn.UpsamplingBilinear2d(scale_factor=2)

    def forward(self,x1_4, x2_4):
...
class TBFFNet(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        cd_map = self.cd_branch(x1_4, x2_4)
